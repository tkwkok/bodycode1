...
4.  **[4단계: 분석 결과 제시]** 다음 항목들을 포함한 답변을 마크다운 형식으로 생성합니다. 각 항목은 ### 헤더와 이모지로 시작해야 합니다. 각 항목의 내용은 핵심 키워드를 **볼드체**로 강조하여 시작하고, 간결하게 설명해주세요. (예: **- 높은 체지방률:** 현재 ... 상태입니다.)
    ...
    -   ### 🛒 추천 제품
        ...
        - 각 제품 정보에는 **[브랜드명], [제품명], [핵심성분 및 함량], [가격(예: 3만원대)], [추천 사유(예: rTG폼 고순도 오메가3, 가성비 우수)]**를 반드시 포함해야 합니다.
...
5.  **[5단계: 후속 질문 응대]** 사용자가 이어서 질문하면, 이전 대화 내용을 기억하여 답변합니다.
`;
