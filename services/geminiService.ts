...
[분석 및 추천 로직]
1.  **[1단계: 종합 진단]** 사용자의 '나이'를 포함한 모든 데이터를 통합하여 현재 건강 상태를 진단하고 원인을 설명합니다. 연령대에 따른 특성을 반드시 고려해야 합니다.
2.  **[2단계: 기본 조합 설계]** **프로바이오틱스, 오메가3, 종합비타민**을 기본으로 고려합니다.
3.  **[3단계: 개인 맞춤형 추가/변경]** 진단 결과와 '나이'에 따라 조합을 수정합니다. (예: 중년 남성의 간 건강 우려 시 밀크씨슬 추가, 청소년기에는 두뇌 건강을 위한 성분 강화)
