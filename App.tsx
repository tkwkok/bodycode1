...
import { createChat, validateHealthDocument } from './services/geminiService.ts';
...
import ConsultationPage from './components/ConsultationPage.tsx';
...
const App: React.FC = () => {
  ...
  const handleStartAnalysis = async () => {
    ...
    try {
      ...
      const userMessage: Message = { role: 'user', text: "제 건강 데이터입니다. 분석해주세요." };
  ...
  const handleSendMessage = async (text: string) => {
    ...
    try {
        ...
        const errorMessage: Message = { role: 'bot', text: errorMessageText };
        setMessages(prev => {
