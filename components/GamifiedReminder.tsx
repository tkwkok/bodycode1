...
import { BellIcon, SparklesIcon } from './icons.tsx';

const times = ['아침', '점심', '저녁'];

interface State {
    reminders: { [supplement: string]: string[] };
    completion: { [supplement: string]: { [time: string]: boolean } };
    points: number;
}

type Action = 
    | { type: 'TOGGLE_REMINDER'; supplement: string; time: string }
    | { type: 'TOGGLE_COMPLETION'; supplement: string; time: string }
