...
import { MicroscopeIcon, PillIcon, ShieldCheckIcon, CartIcon, LeafIcon, BrainIcon, ScaleIcon } from './icons.jsx';
import GamifiedReminder from './GamifiedReminder.jsx';
import SamsungHealthInsights from './SamsungHealthInsights.jsx';
...
const SectionCard = ({title, content, icon: Icon, color}) => {
