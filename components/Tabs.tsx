...
import { BeakerIcon, InfoIcon, ShieldIcon, PencilSquareIcon, LinkIcon } from './icons.tsx';
...
const TabButton: React.FC<TabButtonProps> = ({ label, isActive, onClick, icon: Icon }) => {
    return (
        <button
            onClick={onClick}
