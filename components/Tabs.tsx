...
import { BeakerIcon, InfoIcon, ShieldIcon } from './icons';
...
const Tabs: React.FC<TabsProps> = ({ activeTab, setActiveTab }) => {
    return (
        <div className="flex justify-center items-center p-2 bg-slate-100 dark:bg-slate-800 rounded-full shadow-inner gap-2">
            <TabButton
                label="분석"
