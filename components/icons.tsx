...
export const MicroscopeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a3.375 3.375 0 11-6.75 0h-1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 21V11.25m0 0a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 100 4.5h1.5a2.25 2.25 0 002.25-2.25z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 3v8.25m0 0a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 100 4.5h1.5a2.25 2.25 0 002.25-2.25z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6.75l-3 3m0 0l-3-3m3 3v9" />
  </svg>
);
...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 8L4 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    <path d="M16 6L16 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M20 8L20 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const CartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.831a.75.75 0 00-.685-.945H5.625a.75.75 0 00-.75.75v11.25m0 0A3 3 0 016 18v-1.5m5.25 0v1.5a3 3 0 003 3h.375a3 3 0 003-3v-1.5m-7.5 0h7.5" />
  </svg>
);
...
export const LeafIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.06c0-4.023 2.613-7.5 6.438-7.5 2.66 0 4.864 1.458 5.862 3.562.998-2.104 3.202-3.562 5.862-3.562 3.825 0 6.438 3.477 6.438 7.5 0 4.023-2.613 7.5-6.438 7.5-2.66 0-4.864-1.458-5.862-3.562-.998 2.104-3.202 3.562-5.862 3.562-3.825 0-6.438-3.477-6.438-7.5z" />
  </svg>
);

export const SamsungHealthIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.25 14.25l-3-3 1.06-1.06 1.94 1.94 4.19-4.19L17.5 9.25l-5.25 5z"/>
  </svg>
);
...
export const BeakerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.21 1.02l-1.524 2.682a.75.75 0 00.65 1.186h4.668a.75.75 0 00.65-1.186l-1.524-2.682a2.25 2.25 0 01-.21-1.02V3.104M15.75 3.104V10.5M9 3.104h.008v.008H9V3.104z" />
...
export const ScaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.036.243c-2.132 0-4.14-.724-5.762-2.002M5.25 4.97c-1.01.143-2.01.317-3 .52m3-.52l-2.62 10.726c-.122.499.106 1.028.589 1.202a5.989 5.989 0 002.036.243c2.132 0 4.14-.724 5.762-2.002" />
    </svg>
);
