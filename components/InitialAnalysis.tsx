...
import { MicroscopeIcon, PillIcon, ShieldCheckIcon, CartIcon, LeafIcon, BrainIcon, ScaleIcon } from './icons.tsx';
import GamifiedReminder from './GamifiedReminder.tsx';
import SamsungHealthInsights from './SamsungHealthInsights.tsx';

const colorClasses: { [key: string]: { border: string; bg: string; text: string; darkBg: string } } = {
...
const sectionConfig: { [key: string]: { icon: React.FC<React.SVGProps<SVGSVGElement>>; color: string } } = {
...
const SectionCard: React.FC<SectionCardProps> = ({title, content, icon: Icon, color}) => {
