...
import { createChat, validateHealthDocument } from './services/geminiService.js';
...
const App = () => {
  ...
  const handleStartAnalysis = async () => {
    ...
    try {
      ...
      const userMessage = { role: 'user', text: "제 건강 데이터입니다. 분석해주세요." };
  ...
  const handleSendMessage = async (text) => {
    ...
    try {
        ...
        const errorMessage = { role: 'bot', text: errorMessageText };
        setMessages(prev => {
